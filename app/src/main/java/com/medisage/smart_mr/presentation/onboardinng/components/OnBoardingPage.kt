package com.medisage.smart_mr.presentation.onboardinng.components
...
import com.medisage.smart_mr.presentation.onboardinng.Page
...
fun OnBoardingPage(
    ...
    Column(modifier = modifier) {
        ...
        Text(
            ...
            color = MaterialTheme.colorScheme.onSurface // Use theme-aware color
        )
        Text(
            text = page.title,
            modifier = Modifier.padding(horizontal = MediumPadding2),
